...
public class QaDesignRuleTestCaseExpectImpl extends QaDesignNamedElementImpl implements QaDesignRuleTestCaseExpect {

  public QaDesignRuleTestCaseExpectImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QaDesignVisitor visitor) {
    visitor.visitRuleTestCaseExpect(this);
  }
