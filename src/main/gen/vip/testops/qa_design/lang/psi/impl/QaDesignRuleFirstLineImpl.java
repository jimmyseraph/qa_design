...
public class QaDesignRuleFirstLineImpl extends QaDesignNamedElementImpl implements QaDesignRuleFirstLine {

  public QaDesignRuleFirstLineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QaDesignVisitor visitor) {
    visitor.visitRuleFirstLine(this);
  }
