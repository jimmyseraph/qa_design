...
public class QaDesignRuleTestCaseDataImpl extends QaDesignNamedElementImpl implements QaDesignRuleTestCaseData {

  public QaDesignRuleTestCaseDataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QaDesignVisitor visitor) {
    visitor.visitRuleTestCaseData(this);
  }
