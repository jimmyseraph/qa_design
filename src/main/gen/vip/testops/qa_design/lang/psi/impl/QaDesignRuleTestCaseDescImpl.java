...
public class QaDesignRuleTestCaseDescImpl extends QaDesignNamedElementImpl implements QaDesignRuleTestCaseDesc {

  public QaDesignRuleTestCaseDescImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QaDesignVisitor visitor) {
    visitor.visitRuleTestCaseDesc(this);
  }
